...
```bash
curl -LO https://github.com/nerdy-pro/dxpdf/releases/download/v0.8.1/dxpdf_0.8.1-1_amd64.deb
sudo apt install ./dxpdf_0.8.1-1_amd64.deb
```
...
Validated against ISO 29500 (Office Open XML). **81 entries fully implemented, 11 partial, 8 not yet supported.**
...
Notable gaps: Indic reordering, mirrored tab stops under `w:bidi`, automatic hyphenation, and SmartArt and charts.
