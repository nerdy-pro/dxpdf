...
pub enum StPresetPatternVal {
    ...
    DashHorz, DashVert, Cross, DnDiag, UpDiag, LtDnDiag, LtUpDiag, DkDnDiag, DkUpDiag,
    WdDnDiag, WdUpDiag, DashDnDiag, DashUpDiag, DiagCross,
    SmCheck, LgCheck, SmGrid, LgGrid, DotGrid, SmConfetti, LgConfetti,
    HorzBrick, DiagBrick, SolidDmnd, OpenDmnd, DotDmnd, Plaid, Sphere, Weave,
    DivotShingle, Trellis, ZigZag, Wave,
}
...
impl From<StPresetPatternVal> for PresetPatternVal {
    fn from(s: StPresetPatternVal) -> Self {
        ...
        match s {
            X::Pct5 => Self::Pct5, X::Pct10 => Self::Pct10, X::Pct20 => Self::Pct20,
            X::Pct25 => Self::Pct25, X::Pct30 => Self::Pct30, X::Pct40 => Self::Pct40,
            X::Pct50 => Self::Pct50, X::Pct60 => Self::Pct60, X::Pct70 => Self::Pct70,
            X::Pct75 => Self::Pct75, X::Pct80 => Self::Pct80, X::Pct90 => Self::Pct90,
            X::Horz => Self::Horz, X::Vert => Self::Vert,
            X::LtHorz => Self::LtHorz, X::LtVert => Self::LtVert,
            X::DkHorz => Self::DkHorz, X::DkVert => Self::DkVert,
            X::NarHorz => Self::NarHorz, X::NarVert => Self::NarVert,
            X::DashHorz => Self::DashHorz, X::DashVert => Self::DashVert,
            X::Cross => Self::Cross,
            X::DnDiag => Self::DnDiag, X::UpDiag => Self::UpDiag,
            X::LtDnDiag => Self::LtDnDiag, X::LtUpDiag => Self::LtUpDiag,
            X::DkDnDiag => Self::DkDnDiag, X::DkUpDiag => Self::DkUpDiag,
            X::WdDnDiag => Self::WdDnDiag, X::WdUpDiag => Self::WdUpDiag,
            X::DashDnDiag => Self::DashDnDiag, X::DashUpDiag => Self::DashUpDiag,
            X::DiagCross => Self::DiagCross,
            X::SmCheck => Self::SmCheck, X::LgCheck => Self::LgCheck,
            X::SmGrid => Self::SmGrid, X::LgGrid => Self::LgGrid,
            X::DotGrid => Self::DotGrid,
            X::SmConfetti => Self::SmConfetti, X::LgConfetti => Self::LgConfetti,
            X::HorzBrick => Self::HorzBrick, X::DiagBrick => Self::DiagBrick,
            X::SolidDmnd => Self::SolidDmnd, X::OpenDmnd => Self::OpenDmnd,
            X::DotDmnd => Self::DotDmnd, X::Plaid => Self::Plaid, X::Sphere => Self::Sphere,
            X::Weave => Self::Weave,
            X::DivotShingle => Self::DivotShingle, X::Trellis => Self::Trellis,
            X::ZigZag => Self::ZigZag, X::Wave => Self::Wave,
        }
    }
}
    ...
    fn blip_fill_embed_stretch() {
        match parse(
            ...
            DrawingFill::Blip(b) => {
                ...
                assert_eq!(b.blip.as_ref().and_then(|bl| bl.embed.as_ref()).map(|r| r.as_str()), Some("rId1"));
