...
fn map_preset_shape(val: &str) -> PresetShapeType {
    ...
    match val {
        "rect" => P::Rect, "roundRect" => P::RoundRect, "ellipse" => P::Ellipse,
        "triangle" => P::Triangle, "rtTriangle" => P::RtTriangle, "diamond" => P::Diamond,
        "parallelogram" => P::Parallelogram, "trapezoid" => P::Trapezoid,
        "pentagon" => P::Pentagon, "hexagon" => P::Hexagon, "octagon" => P::Octagon,
        "star4" => P::Star4, "star5" => P::Star5, "star6" => P::Star6, "star8" => P::Star8,
        "star10" => P::Star10, "star12" => P::Star12, "star16" => P::Star16,
        "star24" => P::Star24, "star32" => P::Star32, "line" => P::Line, "plus" => P::Plus,
        "can" => P::Can, "cube" => P::Cube, "donut" => P::Donut, "noSmoking" => P::NoSmoking,
        "blockArc" => P::BlockArc, "heart" => P::Heart, "sun" => P::Sun, "moon" => P::Moon,
        "smileyFace" => P::SmileyFace, "lightningBolt" => P::LightningBolt,
        "cloud" => P::Cloud, "arc" => P::Arc, "plaque" => P::Plaque, "frame" => P::Frame,
        "bevel" => P::Bevel, "foldedCorner" => P::FoldedCorner, "chevron" => P::Chevron,
        "homePlate" => P::HomePlate, "ribbon" => P::Ribbon, "ribbon2" => P::Ribbon2,
        "pie" => P::Pie, "pieWedge" => P::PieWedge, "chord" => P::Chord, "teardrop" => P::Teardrop,
        "arrow" => P::Arrow, "leftArrow" => P::LeftArrow, "rightArrow" => P::RightArrow,
        "upArrow" => P::UpArrow, "downArrow" => P::DownArrow,
        "leftRightArrow" => P::LeftRightArrow, "upDownArrow" => P::UpDownArrow,
        "quadArrow" => P::QuadArrow, "bentArrow" => P::BentArrow, "uturnArrow" => P::UturnArrow,
        "circularArrow" => P::CircularArrow, "curvedRightArrow" => P::CurvedRightArrow,
        "curvedLeftArrow" => P::CurvedLeftArrow, "curvedUpArrow" => P::CurvedUpArrow,
        "curvedDownArrow" => P::CurvedDownArrow, "stripedRightArrow" => P::StripedRightArrow,
        "notchedRightArrow" => P::NotchedRightArrow, "bentUpArrow" => P::BentUpArrow,
        "leftUpArrow" => P::LeftUpArrow, "leftRightUpArrow" => P::LeftRightUpArrow,
        "leftArrowCallout" => P::LeftArrowCallout, "rightArrowCallout" => P::RightArrowCallout,
        "upArrowCallout" => P::UpArrowCallout, "downArrowCallout" => P::DownArrowCallout,
        "leftRightArrowCallout" => P::LeftRightArrowCallout,
        "upDownArrowCallout" => P::UpDownArrowCallout,
        "quadArrowCallout" => P::QuadArrowCallout, "swooshArrow" => P::SwooshArrow,
        "leftCircularArrow" => P::LeftCircularArrow,
        "leftRightCircularArrow" => P::LeftRightCircularArrow,
        "callout1" => P::Callout1, "callout2" => P::Callout2, "callout3" => P::Callout3,
        "accentCallout1" => P::AccentCallout1, "accentCallout2" => P::AccentCallout2,
        "accentCallout3" => P::AccentCallout3, "borderCallout1" => P::BorderCallout1,
        "borderCallout2" => P::BorderCallout2, "borderCallout3" => P::BorderCallout3,
        ...
        "wedgeEllipseCallout" => P::WedgeEllipseCallout, "cloudCallout" => P::CloudCallout,
        "leftBracket" => P::LeftBracket, "rightBracket" => P::RightBracket,
        "leftBrace" => P::LeftBrace, "rightBrace" => P::RightBrace,
        "bracketPair" => P::BracketPair, "bracePair" => P::BracePair,
        "straightConnector1" => P::StraightConnector1,
        "bentConnector2" => P::BentConnector2, "bentConnector3" => P::BentConnector3,
        "bentConnector4" => P::BentConnector4, "bentConnector5" => P::BentConnector5,
        "curvedConnector2" => P::CurvedConnector2, "curvedConnector3" => P::CurvedConnector3,
        "curvedConnector4" => P::CurvedConnector4, "curvedConnector5" => P::CurvedConnector5,
        ...
        "flowChartOr" => P::FlowChartOr, "flowChartCollate" => P::FlowChartCollate,
        "flowChartSort" => P::FlowChartSort, "flowChartExtract" => P::FlowChartExtract,
        ...
        "flowChartDisplay" => P::FlowChartDisplay, "flowChartDelay" => P::FlowChartDelay,
        ...
        "actionButtonHome" => P::ActionButtonHome, "actionButtonHelp" => P::ActionButtonHelp,
        ...
        "irregularSeal1" => P::IrregularSeal1, "irregularSeal2" => P::IrregularSeal2,
        "wave" => P::Wave, "doubleWave" => P::DoubleWave,
        "ellipseRibbon" => P::EllipseRibbon, "ellipseRibbon2" => P::EllipseRibbon2,
        "verticalScroll" => P::VerticalScroll, "horizontalScroll" => P::HorizontalScroll,
        "leftRightRibbon" => P::LeftRightRibbon, "gear6" => P::Gear6, "gear9" => P::Gear9,
        "funnel" => P::Funnel, "mathPlus" => P::MathPlus, "mathMinus" => P::MathMinus,
        "mathMultiply" => P::MathMultiply, "mathDivide" => P::MathDivide,
        "mathEqual" => P::MathEqual, "mathNotEqual" => P::MathNotEqual,
        "cornerTabs" => P::CornerTabs, "squareTabs" => P::SquareTabs,
        "plaqueTabs" => P::PlaqueTabs, "chartX" => P::ChartX, "chartStar" => P::ChartStar,
        "chartPlus" => P::ChartPlus, "halfFrame" => P::HalfFrame, "corner" => P::Corner,
        "diagStripe" => P::DiagStripe,
        "nonIsoscelesTrapezoid" => P::NonIsoscelesTrapezoid,
        "heptagon" => P::Heptagon, "decagon" => P::Decagon, "dodecagon" => P::Dodecagon,
        "round1Rect" => P::Round1Rect, "round2SameRect" => P::Round2SameRect,
        "round2DiagRect" => P::Round2DiagRect, "snipRoundRect" => P::SnipRoundRect,
        "snip1Rect" => P::Snip1Rect, "snip2SameRect" => P::Snip2SameRect,
...
mod tests {
    use super::*;
    use crate::docx::model::{
        PathFillMode, PresetShapeType, ShapeGeometry, TextWrappingType,
    };
